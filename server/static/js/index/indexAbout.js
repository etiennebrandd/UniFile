...
const featureData = [
  {
    ...
    image: 'images/landing/recipe-feature-image.jpg',
  ...
  },
  {
    ...
    image: 'images/landing/meal-feature-image.jpg',
  ...
  },
  {
    ...
    image: 'images/landing/pantry-feature-image.jpg',
    imageAlt: 'An image of something',
  ...
  btn.addEventListener('click', () => {
    ...
    if (!btn.classList.contains('desktop-features__tab--active')) {
      ...
      <div class="desktop-features__image">
        <img src="{{ url_for('static', filename='${chosenFeature.image}') }}" alt="${chosenFeature.imageAlt}">
      </div>`);
    }
  });
}
